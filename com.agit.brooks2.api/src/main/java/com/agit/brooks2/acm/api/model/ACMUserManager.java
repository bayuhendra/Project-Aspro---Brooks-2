...
//    private AcmAdapter acmAdapter = new AcmAdapterImpl();
    ...
    public User findUserById(final String userId) {
        ...
        User u = acmTemplate.execute(new ACMCallBack<User>() {
            ...
            public User executeInACMContext() {
                ...
                /*find User*/
                com.agit.brooks2.user.management.domain.user.User user = userRepository.findByID(userId);
    ...
    private User toUser(final com.agit.brooks2.user.management.domain.user.User o) {
        User u = new User() {
